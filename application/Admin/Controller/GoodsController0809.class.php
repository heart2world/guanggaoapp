            ...
            try{
                ...
                if(count($spec_ids) >0)
                {
                    ...
                    while ($k < $len) {
                        ...
                        $a = array('title' => $optionArray['option_title'][$k], 'sale_price' => $optionArray['option_dropprice'][$k], 'settleprice' => $optionArray['option_settleprice'][$k], 'unit' => $optionArray['option_weight'][$k],'goods_id' => $good_id, 'specs_item' => $newids);
